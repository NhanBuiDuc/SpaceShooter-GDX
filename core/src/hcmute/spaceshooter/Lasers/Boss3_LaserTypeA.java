...
import static hcmute.spaceshooter.GlobalVariables.boss3_LaserTypeA_Texture;

import com.badlogic.gdx.graphics.Texture;
import com.badlogic.gdx.graphics.g2d.Batch;
import com.badlogic.gdx.math.Rectangle;

public class Boss3_LaserTypeA extends EnemyLaser {
    // level of the bullet
    int level = 1;
    // the ship's drawing rectangle
    Rectangle shipBoundingBox;
    // Constructor
    public Boss3_LaserTypeA(Rectangle shipBoundingBox) {
        // the ship's drawing rectangle
        this.shipBoundingBox = shipBoundingBox;
        // the laser's texture
        laserTexture = boss3_LaserTypeA_Texture;
        // the laser width
        laserWidth = 20f;
        // the laser height
     ...
     */
    public Boss3_LaserTypeA[] GetBullets(){
        Boss3_LaserTypeA[] lasers = new Boss3_LaserTypeA[20];

        lasers[0] = new Boss3_LaserTypeA(shipBoundingBox);
