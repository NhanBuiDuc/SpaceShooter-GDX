...
//                laserTextureNum, laserRowTextureCount, laserColumnTextureCount);
    ...
    public Boss1_LaserTypeB[] GetBullets() {
        ...
        if(level == 1){
            ...
            lasers[0].setLaserBoundingBox(new Rectangle(lasers[0].getShipBoundingBox().getX() - lasers[0].getShipBoundingBox().width * 0.1f,
                    lasers[0].getShipBoundingBox().getY() + lasers[1].getShipBoundingBox().height * 0.2f,
            ...
            lasers[1].setLaserBoundingBox(new Rectangle(lasers[1].getShipBoundingBox().getX() + lasers[1].getShipBoundingBox().getWidth() * 0.7f,
                    lasers[1].getShipBoundingBox().getY() + lasers[1].getShipBoundingBox().height * 0.2f,
