...
import static hcmute.spaceshooter.GlobalVariables.magicCircleTexture;
...
public class LaserTypeD extends Laser {
    ...
    public LaserTypeD(Rectangle shipBoundingBox) {
        ...
        typeName = "RED";
        laserTexture = magicCircleTexture;
