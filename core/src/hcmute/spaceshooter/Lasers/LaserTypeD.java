...
import static hcmute.spaceshooter.GlobalVariables.archBulletTexture;
...
public class LaserTypeD extends Laser {
    ...
    public LaserTypeD(float xCentre, float yBottom, float laserWidth, float laserHeight, float laserMovementSpeed, Texture laserTexture) {
    ...
    public LaserTypeD(Rectangle shipBoundingBox) {
        this.shipBoundingBox = shipBoundingBox;
        typeName = "ARCH";
        damage = 3;
        laserTexture = archBulletTexture;
    ...
    public LaserTypeD[] GetBullets(){
        LaserTypeD[] lasers = new LaserTypeD[20];
        if(level == 1)
        {
...
//                    laserWidth, laserHeight, laserMovementSpeed, laserTextureRegion);
            ...
            lasers[0] = new LaserTypeD(shipBoundingBox);
            ...
            lasers[1] = new LaserTypeD(shipBoundingBox);
            lasers[1].setLaserWidth(laserWidth);
            lasers[1].setLaserHeight(laserHeight);
            lasers[1].setLaserMovementSpeed(laserMovementSpeed);
            lasers[1].setLaserBoundingBox(new Rectangle(lasers[1].getShipBoundingBox().getX() + lasers[1].getShipBoundingBox().getWidth() * 0.5f,
        ...
        if(level == 2){
            ...
            lasers[1].setLaserHeight(laserHeight);
            lasers[1].setLaserMovementSpeed(laserMovementSpeed);
            lasers[1].setLaserBoundingBox(new Rectangle(lasers[1].getShipBoundingBox().getX() + lasers[1].getShipBoundingBox().getWidth() * 0.15f,
                    lasers[1].getShipBoundingBox().getY() + lasers[1].getShipBoundingBox().getHeight() * 1,
                    lasers[1].getLaserWidth(), lasers[1].getLaserHeight()));


            lasers[2] = new LaserTypeD(shipBoundingBox);
            lasers[2].setLaserWidth(laserWidth);
            lasers[2].setLaserHeight(laserHeight);
            lasers[2].setLaserMovementSpeed(laserMovementSpeed);
            lasers[2].setLaserBoundingBox(new Rectangle(lasers[2].getShipBoundingBox().getX() + lasers[2].getShipBoundingBox().getWidth() * 0.50f,
        ...
        if(level == 3){
            ...
            lasers[2].setLaserBoundingBox(new Rectangle(lasers[2].getShipBoundingBox().getX() + lasers[2].getShipBoundingBox().getWidth() * 0.5f,
                    lasers[2].getShipBoundingBox().getY() + lasers[2].getShipBoundingBox().getHeight() * 0.55f,
                    lasers[2].getLaserWidth(), lasers[2].getLaserHeight()));
        ...
        if(level == 4){
            ...
            // Thứ 2 từ trái qua
            lasers[3] = new LaserTypeD(shipBoundingBox);
            ...
            // Thứ 2 từ phải qua
            lasers[4] = new LaserTypeD(shipBoundingBox);
            ...
            lasers[4].setLaserBoundingBox(new Rectangle(lasers[4].getShipBoundingBox().getX() + lasers[4].getShipBoundingBox().getWidth() * 0.5f,
        ...
        if(level == 5){
            ...
            lasers[1].setLaserBoundingBox(new Rectangle(lasers[1].getShipBoundingBox().getX() + lasers[1].getShipBoundingBox().getWidth() * 0.13f,
                    lasers[1].getShipBoundingBox().getY() + lasers[1].getShipBoundingBox().getHeight() * 1,
                    lasers[1].getLaserWidth(), lasers[1].getLaserHeight()));
            ...
            lasers[4].setLaserBoundingBox(new Rectangle(lasers[4].getShipBoundingBox().getX() + lasers[4].getShipBoundingBox().getWidth() * 0.7f,
                    ...
                    lasers[4].getLaserWidth(), lasers[4].getLaserHeight()));
            // Thứ 3 từ trái qua
            lasers[5] = new LaserTypeD(shipBoundingBox);
            ...
            lasers[5].setLaserBoundingBox(new Rectangle(lasers[5].getShipBoundingBox().getX() - lasers[5].getShipBoundingBox().getWidth() * 0.2f,
            ...
            // Thứ 3 từ phải qua
            lasers[6] = new LaserTypeD(shipBoundingBox);
            ...
            lasers[6].setLaserBoundingBox(new Rectangle(lasers[6].getShipBoundingBox().getX() + lasers[6].getShipBoundingBox().getWidth() * 0.5f,
            ...
            // Giữa phải
            lasers[7] = new LaserTypeD(shipBoundingBox);
            ...
            lasers[7].setLaserBoundingBox(new Rectangle(lasers[7].getShipBoundingBox().getX() + lasers[7].getShipBoundingBox().getWidth() * 0.17f,
    ...
    public void setBullets(LaserTypeD[] bullets) {
