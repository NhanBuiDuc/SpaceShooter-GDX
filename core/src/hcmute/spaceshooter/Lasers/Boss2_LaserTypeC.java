...
public class Boss2_LaserTypeC extends EnemyLaser {
     ...
     */
    public Boss2_LaserTypeB[] GetBullets() {
        Boss2_LaserTypeB[] lasers = new Boss2_LaserTypeB[7];
        if (level == 1) {

            lasers[0] = new Boss2_LaserTypeB(shipBoundingBox);
            ...
            lasers[1] = new Boss2_LaserTypeB(shipBoundingBox);
            ...
            lasers[2] = new Boss2_LaserTypeB(shipBoundingBox);
            ...
            lasers[3] = new Boss2_LaserTypeB(shipBoundingBox);
            ...
            lasers[4] = new Boss2_LaserTypeB(shipBoundingBox);
            ...
            lasers[5] = new Boss2_LaserTypeB(shipBoundingBox);
    ...
    public void setBullets(Boss2_LaserTypeB[] bullets) {
