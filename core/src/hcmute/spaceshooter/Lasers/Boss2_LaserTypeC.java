...
public class Boss2_LaserTypeC extends EnemyLaser {
     ...
     */
    public Boss2_LaserTypeC[] GetBullets() {
        Boss2_LaserTypeC[] lasers = new Boss2_LaserTypeC[7];
        if (level == 1) {

            lasers[0] = new Boss2_LaserTypeC(shipBoundingBox);
            ...
            lasers[1] = new Boss2_LaserTypeC(shipBoundingBox);
            ...
            lasers[2] = new Boss2_LaserTypeC(shipBoundingBox);
            ...
            lasers[3] = new Boss2_LaserTypeC(shipBoundingBox);
            ...
            lasers[4] = new Boss2_LaserTypeC(shipBoundingBox);
            ...
            lasers[5] = new Boss2_LaserTypeC(shipBoundingBox);
    ...
    public void setBullets(Boss2_LaserTypeC[] bullets) {
